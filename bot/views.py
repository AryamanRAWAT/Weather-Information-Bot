...
'''{"update_id":593872375,\n"message":{"message_id":2749,"from":{"id":5164975159,"is_bot":false,"first_name":"A","last_name":"R","language_code":"en"},
"chat":{"id":5164975159,"first_name":"A","last_name":"R","type":"private"},"date":1652994955,"text":"Hi"}}'''
@csrf_exempt
def home(request):
    try:
